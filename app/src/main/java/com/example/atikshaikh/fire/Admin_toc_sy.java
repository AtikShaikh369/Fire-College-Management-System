...
public class Admin_toc_sy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toc_sy);
        db = FirebaseFirestore.getInstance();
        checkboxes  = db.collection("TOC").document("Syllabus");

        c1 = findViewById(R.id.atoccb1);
        c2 = findViewById(R.id.atoccb2);
        c3 = findViewById(R.id.atoccb3);
        c4 = findViewById(R.id.atoccb4);
        c5 = findViewById(R.id.atoccb5);
        c6 = findViewById(R.id.atoccb6);
        c7 = findViewById(R.id.atoccb7);
        c8 = findViewById(R.id.atoccb8);
        c9 = findViewById(R.id.atoccb9);
        c10 = findViewById(R.id.atoccb10);
        c11 = findViewById(R.id.atoccb11);
        c12 = findViewById(R.id.atoccb12);
