...
public class Admin_isee_sy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_isee_sy);
        db = FirebaseFirestore.getInstance();
        checkboxes  = db.collection("ISEE").document("Syllabus");

        c1 = findViewById(R.id.aiseecb1);
        c2 = findViewById(R.id.aiseecb2);
        c3 = findViewById(R.id.aiseecb3);
        c4 = findViewById(R.id.aiseecb4);
        c5 = findViewById(R.id.aiseecb5);
        c6 = findViewById(R.id.aiseecb6);
        c7 = findViewById(R.id.aiseecb7);
        c8 = findViewById(R.id.aiseecb8);
        c9 = findViewById(R.id.aiseecb9);
        c10 = findViewById(R.id.aiseecb10);
        c11 = findViewById(R.id.aiseecb11);
        c12 = findViewById(R.id.aiseecb12);
