...
public class Userdbmssy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userdbmssy);

        db = FirebaseFirestore.getInstance();
        checkboxes  = db.collection("DBMS").document("Syllabus");

        c1 = findViewById(R.id.udbmscb1);
        c2 = findViewById(R.id.udbmscb2);
        c3 = findViewById(R.id.udbmscb3);
        c4 = findViewById(R.id.udbmscb4);
        c5 = findViewById(R.id.udbmscb5);
        c6 = findViewById(R.id.udbmscb6);
        c7 = findViewById(R.id.udbmscb7);
        c8 = findViewById(R.id.udbmscb8);
        c9 = findViewById(R.id.udbmscb9);
        c10 = findViewById(R.id.udbmscb10);
        c11 = findViewById(R.id.udbmscb11);
        c12 = findViewById(R.id.udbmscb12);
