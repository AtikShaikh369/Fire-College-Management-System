...
public class Usersepmsy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usersepmsy);

        db = FirebaseFirestore.getInstance();
        checkboxes = db.collection("SEPM").document("Syllabus");

        c1 = findViewById(R.id.usepmcb1);
        c2 = findViewById(R.id.usepmcb2);
        c3 = findViewById(R.id.usepmcb3);
        c4 = findViewById(R.id.usepmcb4);
        c5 = findViewById(R.id.usepmcb5);
        c6 = findViewById(R.id.usepmcb6);
        c7 = findViewById(R.id.usepmcb7);
        c8 = findViewById(R.id.usepmcb8);
        c9 = findViewById(R.id.usepmcb9);
        c10 = findViewById(R.id.usepmcb10);
        c11 = findViewById(R.id.usepmcb11);
        c12 = findViewById(R.id.usepmcb12);
