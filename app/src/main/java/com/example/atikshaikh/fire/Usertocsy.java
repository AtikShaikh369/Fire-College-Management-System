...
public class Usertocsy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usertocsy);

        db = FirebaseFirestore.getInstance();
        checkboxes = db.collection("TOC").document("Syllabus");

        c1 = findViewById(R.id.utoccb1);
        c2 = findViewById(R.id.utoccb2);
        c3 = findViewById(R.id.utoccb3);
        c4 = findViewById(R.id.utoccb4);
        c5 = findViewById(R.id.utoccb5);
        c6 = findViewById(R.id.utoccb6);
        c7 = findViewById(R.id.utoccb7);
        c8 = findViewById(R.id.utoccb8);
        c9 = findViewById(R.id.utoccb9);
        c10 = findViewById(R.id.utoccb10);
        c11 = findViewById(R.id.utoccb11);
        c12 = findViewById(R.id.utoccb12);
