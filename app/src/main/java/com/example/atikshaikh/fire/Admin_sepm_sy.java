...
public class Admin_sepm_sy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sepm_sy);
        db = FirebaseFirestore.getInstance();
        checkboxes  = db.collection("SEPM").document("Syllabus");

        c1 = findViewById(R.id.asepmcb1);
        c2 = findViewById(R.id.asepmcb2);
        c3 = findViewById(R.id.asepmcb3);
        c4 = findViewById(R.id.asepmcb4);
        c5 = findViewById(R.id.asepmcb5);
        c6 = findViewById(R.id.asepmcb6);
        c7 = findViewById(R.id.asepmcb7);
        c8 = findViewById(R.id.asepmcb8);
        c9 = findViewById(R.id.asepmcb9);
        c10 = findViewById(R.id.asepmcb10);
        c11 = findViewById(R.id.asepmcb11);
        c12 = findViewById(R.id.asepmcb12);
