...
public class Useriseesy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_useriseesy);

        db = FirebaseFirestore.getInstance();
        checkboxes = db.collection("ISEE").document("Syllabus");

        c1 = findViewById(R.id.uiseecb1);
        c2 = findViewById(R.id.uiseecb2);
        c3 = findViewById(R.id.uiseecb3);
        c4 = findViewById(R.id.uiseecb4);
        c5 = findViewById(R.id.uiseecb5);
        c6 = findViewById(R.id.uiseecb6);
        c7 = findViewById(R.id.uiseecb7);
        c8 = findViewById(R.id.uiseecb8);
        c9 = findViewById(R.id.uiseecb9);
        c10 = findViewById(R.id.uiseecb10);
        c11 = findViewById(R.id.uiseecb11);
        c12 = findViewById(R.id.uiseecb12);
